...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scrabble_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scrabble.css */ \"./src/scrabble.css\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ \"jquery\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _sorted_combinations_txt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sorted_combinations.txt */ \"./src/sorted_combinations.txt\");\n\n\n\n\nconsole.log({ syllableCombinations: _sorted_combinations_txt__WEBPACK_IMPORTED_MODULE_2__ })\n\nfunction partition(size, coll, pad = []) {\n    if (size <= 0) throw new Error(\"Partition size must be greater than 0\");\n    \n    let result = [];\n    for (let i = 0; i < coll.length; i += size) {\n      let chunk = coll.slice(i, i + size);\n      if (chunk.length < size) {\n        chunk = chunk.concat(pad.slice(0, size - chunk.length));\n      }\n      result.push(chunk);\n    }\n    \n    return result;\n  }\n\njquery__WEBPACK_IMPORTED_MODULE_1___default().when((jquery__WEBPACK_IMPORTED_MODULE_1___default().ready)).then(function () {\n    /** @type {string} */\n    let combinations = _sorted_combinations_txt__WEBPACK_IMPORTED_MODULE_2__\n\n    jquery__WEBPACK_IMPORTED_MODULE_1___default()('main').append('<div class=\"syllables-container\"></div>')\n\n    let partitionSize = 15;\n    /** @type {string[]} */\n    let combinationsColl = combinations\n        .trim()\n        .split(' ')\n    /** @type {string[][]} */\n    let coll = partition(partitionSize, combinationsColl, ['a', 'e', 'i', 'o', 'u'])\n    coll.forEach((syllables, idx) => {\n        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.syllables-container').append(`<div class=\"row-${idx + 1}\"></div>`)\n        let container = jquery__WEBPACK_IMPORTED_MODULE_1___default()(`.syllables-container .row-${idx + 1}`)\n        syllables.forEach(syllable => {\n            container.append(`<div class=\"syllable\">\n                        <span>${syllable}</span>\n                    </div>`)\n        })\n    })\n})\n\n//# sourceURL=webpack://caligrafia/./src/scrabble.js?");
